...
void LoRaScan(){
    ...
    while (1) {
        ...
        // if (strcmp(Msg_In, STBY1)==0) {
        //     Debug.printf("   STBY1 DETECTED\r\n");
        //     memset(Msg_In, 0, sizeof(Msg_In));

        // } else if (strcmp(Msg_In, STBY1_Not)==0) {
        ...
        if ((strcmp(Msg_In, STBY1)==0)||(strcmp(Msg_In, STBY1_NoLine)==0)) {
            Debug.printf("STBY1 DETECTED\r\n");
            memset(Msg_In, 0, sizeof(Msg_In));
            StandbyOn();
            GetReady_int =1;
            Go_Off();
        } else if ((strcmp(Msg_In, STBY1_Not)==0)||(strcmp(Msg_In, STBY1_Not_NoLine)==0)) {
            Debug.printf("STBY OFF Detected\r\n");
            memset(Msg_In, 0, sizeof(Msg_In));
            StandbyOff();
            ConfirmedReady_Off();
        ...
        }else if (  (strcmp(Msg_In, STBY2)==0)||(strcmp(Msg_In, STBY2_NoLine)==0)||(strcmp(Msg_In, STBY2_Not)==0)||(strcmp(Msg_In, STBY2_Not_NoLine)==0)||((strcmp(Msg_In, GO2)==0)) ){
