...
void LoRaScan(){
    ...
    while (1) {
        ...
        if ((strcmp(Msg_In, STBY3)==0)||(strcmp(Msg_In, STBY3_NoLine)==0)) {
            Debug.printf("STBY3 DETECTED\r\n");
            memset(Msg_In, 0, sizeof(Msg_In));
            StandbyOn();
            GetReady_int =1;
            Go_Off();
        } else if ((strcmp(Msg_In, STBY3_Not)==0)||(strcmp(Msg_In, STBY3_Not_NoLine)==0)) {
            Debug.printf("STBY OFF Detected\r\n");
            memset(Msg_In, 0, sizeof(Msg_In));
            StandbyOff();
            ConfirmedReady_Off();
